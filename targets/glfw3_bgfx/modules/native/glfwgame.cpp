...
// prototypes for bgfx_callback_vtbl_t
...
void BBGlfwGame::Run(){
	...
	uint32_t width  = CFG_GLFW_WINDOW_WIDTH;
	uint32_t height = CFG_GLFW_WINDOW_HEIGHT;
	...
	m_callback_vtbl.fatal = bgfx_callback_fatal;
	m_callback_vtbl.trace_vargs = bgfx_callback_trace_vargs;
	m_callback_vtbl.profiler_begin = bgfx_callback_profiler_begin;
	m_callback_vtbl.profiler_begin_literal = bgfx_callback_profiler_begin_literal;
	m_callback_vtbl.profiler_end = bgfx_callback_profiler_end;
	m_callback_vtbl.cache_read_size = bgfx_callback_cache_read_size;
	m_callback_vtbl.cache_read = bgfx_callback_cache_read;
	m_callback_vtbl.cache_write = bgfx_callback_cache_write;
	m_callback_vtbl.screen_shot = bgfx_callback_screen_shot;
	m_callback_vtbl.capture_begin = bgfx_callback_capture_begin;
	m_callback_vtbl.capture_end = bgfx_callback_capture_end;
	m_callback_vtbl.capture_frame = bgfx_callback_capture_frame;

	m_callback_interface.vtbl = &m_callback_vtbl;

	// init.callback->vtbl = &m_callback_vtbl;
